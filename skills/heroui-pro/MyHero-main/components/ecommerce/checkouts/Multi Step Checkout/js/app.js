...
export default function Component() {
  ...
  return (
    <section className="flex h-[calc(100vh-60px)] w-full gap-8">
      {/* Left */}
      <div className="w-full flex-none py-4 lg:w-[44%]">
        <div className="flex justify-between px-2">
          ...
          <div className="flex items-center gap-2">
            <p>
              <span className="text-small text-default-700 font-semibold">$172.96</span>
              <span className="text-small text-default-500 ml-1">(3 items)</span>
            </p>
        ...
        <div className="flex h-full flex-1 flex-col p-4">
          <div>
            <Button
              className="text-default-700 -ml-2"
              isDisabled={page === 0}
              radius="full"
              variant="flat"
              onPress={() => paginate(-1)}
          ...
          <div className="mt-auto flex w-full justify-between gap-8 pt-4 pb-8">
      ...
      {/* Right */}
      <div className="rounded-medium shadow-small relative hidden w-full overflow-hidden lg:block">
        {/* Top Shadow */}
        <div className="rounded-medium absolute top-0 z-10 h-32 w-full bg-linear-to-b from-black/80 to-transparent" />
        {/* Bottom Shadow */}
        <div className="rounded-medium absolute bottom-0 z-10 h-32 w-full bg-linear-to-b from-transparent to-black/80" />


        {/* Content */}
        <div className="absolute top-10 z-10 flex w-full items-start justify-between px-10">
          <h2 className="text-2xl font-medium text-white/70 [text-shadow:0_2px_10px_rgb(0_0_0/20%)]">
        ...
        <div className="rounded-medium bg-background/10 dark:bg-default-100/50 absolute inset-x-4 bottom-4 z-10 flex items-center justify-between p-8 backdrop-blur-md backdrop-saturate-150">
