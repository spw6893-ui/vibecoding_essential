...
const OpenCollectiveIcon = ({size = 24, width, height, ...props}) => {
  return (
    <svg
      fill="none"
      height={size || height}
...
const PatreonIcon = ({size = 24, width, height, ...props}) => {
  return (
    <svg
      fill="none"
      height={size || height}
...
const NextJsIcon = ({size = 24, width, height, ...props}) => {
  return (
    <svg
      aria-hidden="true"
      height={size || height}
...
const NpmIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      aria-hidden="true"
      fill="currentColor"
...
const NpmSmallIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      fill="currentColor"
      focusable="false"
...
// #E1251B
export const AdobeIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      aria-hidden="true"
      aria-label="Adobe"
...
const YarnIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      aria-hidden="true"
      fill="currentColor"
...
const PnpmIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      aria-hidden="true"
      fill="currentColor"
...
const AstroIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
...
const NewNextJSIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg aria-hidden="true" fill="none" focusable="false" height={height} width={width} {...props}>
      <mask
        height="26"
...
const RemixIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
const ViteIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
const StorybookIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
const CodeSandboxIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      fill="none"
      height={height}
...
const JavascriptIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      fill="currentColor"
      height={height}
...
const TypescriptIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg
      fill="currentColor"
      height={height}
...
const GoogleIcon = ({size = 24, width, height, ...props}) => {
  return (
    <svg
      focusable="false"
      height={size || height}
...
const AppleIcon = ({width = "1em", height = "1em", ...props}) => {
  return (
    <svg fill="currentColor" height={height} viewBox="0 0 24 24" width={width} {...props}>
      <path
